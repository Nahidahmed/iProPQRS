...
WriteLiteral(" value=\"volvo\"");

WriteLiteral(">Volvo</option>\n\t\t\t  <option");

WriteLiteral(" value=\"saab\"");

WriteLiteral(">Saab</option>\n\t\t\t  <option");

WriteLiteral(" value=\"opel\"");

WriteLiteral(">Opel</option>\n\t\t\t  <option");

WriteLiteral(" value=\"audi\"");

WriteLiteral(">Audi</option>\n\t\t\t</select>\n\t\t</p>\n\t\t<p><input");
...
WriteLiteral(" onclick=\"alert(\'Hi\')\"");

WriteLiteral(" />\n");


#line 29 "ToDoView.cshtml"
